...
function auto_gr_permalinks_settings_init() {
	...
	add_settings_section(
		'auto_gr_permalinks_main',
		__( 'Automatic Conversion', 'auto_gr_permalinks' ),
		'auto_gr_permalinks_main_cb',
		'auto_gr_permalinks'
	);
	add_settings_field(
		'auto_gr_permalinks_automatic',
		__( 'Automatic conversion of new posts/terms to greeklish', 'auto_gr_permalinks' ),
		'auto_gr_permalinks_automatic_cb',
		'auto_gr_permalinks',
		'auto_gr_permalinks_main'
	);
	
	add_settings_section(
		'auto_gr_permalinks_custom',
		__( 'Customizations', 'auto_gr_permalinks' ),
		'auto_gr_permalinks_custom_cb',
		'auto_gr_permalinks'
	);
	add_settings_field(
		'auto_gr_permalinks_diphthongs',
		__( 'Do you want diphthongs to be converted?', 'auto_gr_permalinks' ),
		'auto_gr_permalinks_diphthongs_cb',
		'auto_gr_permalinks',
		'auto_gr_permalinks_custom'
	);
}
...
function auto_gr_permalinks_automatic_cb() {
	...
	?>
	<label class="switch">
		<input type="checkbox" id="auto_gr_permalinks_automatic" name="auto_gr_permalinks_automatic" value="enabled" <?php echo $automatic; ?>>
...
function auto_gr_permalinks_diphthongs_cb() {
	...
	?>
	<label class="switch">
		<input type="checkbox" id="auto_gr_permalinks_diphthongs" name="auto_gr_permalinks_diphthongs" value="enabled" <?php echo $diphthongs; ?>>
		<span class="slider round"></span>
	</label>
...
function auto_gr_permalinks_admin_page() {
	...
	<div class="wrap">
		...
		<h2 class="nav-tab-wrapper">
			...
			<a href="?page=auto_gr_permalinks&tab=generate_permalinks" class="nav-tab <?php echo $active_tab == 'generate_permalinks' ? 'nav-tab-active' : ''; ?>"><?php _e('Convert old posts/terms', 'auto_gr_permalinks'); ?></a>
		</h2>
		<?php
		...
		<?php  } else { ?>
			<div>
				<form action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI'] ); ?>" method="post">
					<table class="form-table">
						<tbody>
							<tr>
								...
								<td>
									<select title="<?php _e('Post types to convert', 'auto_gr_permalinks'); ?>" name="post-type[]" class="select2" data-placeholder="<?php _e('Select one or more post types', 'auto_gr_permalinks'); ?>" multiple>
									<?php
										$args = array(
											'public' => true,
										);
							...
							<tr>
								...
								<td>
									<select title="<?php _e('Taxonomies to convert', 'auto_gr_permalinks'); ?>" name="taxonomy[]" class="select2" data-placeholder="<?php _e('Select one or more taxonomies', 'auto_gr_permalinks'); ?>" multiple>
										<?php
										$args = array(
											'public' => true,
										);
					...
					<p class="submit">
						<input type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e('Convert Permalinks', 'auto_gr_permalinks'); ?>">
					</p>
				</form>
			</div>
			<script>
